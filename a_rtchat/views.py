...
def chat_view(request, chatroom_name='public-chat'):
    ...
    context = {
        'chat_messages': chat_messages, 'form': form, 'other_user': other_user, 'chatroom_name': chatroom_name, 'chat_group': chat_group
    }
...
def chatroom_edit_view(request, chatroom_name):
    ...
    return render(request, 'a_rtchat/chatrooom_edit.html', context)
...
def chatroom_delete_view(request, chatroom_name):
    ...
    if request.method == "POST":
        ...
        print(f"Request Method is not POST but {request.method}")

    try:
        referer = request.META.get('HTTP_REFERER', '/')
        return render(request, 'a_rtchat/chatroom_delete.html', {'chat_group': chat_group, 'referer': referer})
